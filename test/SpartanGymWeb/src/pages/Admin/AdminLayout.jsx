      ...
      <div className="flex min-h-dvh min-w-0 flex-1 flex-col overflow-hidden">
        <header className="z-30 flex min-h-16 items-center justify-between gap-3 border-b border-white/5 bg-[#050505]/80 px-3 py-3 backdrop-blur-md sm:min-h-20 sm:px-6 lg:px-8">
          ...
          <div className="flex shrink-0 items-center gap-3 sm:gap-4">
            <button type="button" onClick={() => navigate('/recepcion/notificaciones')} className="rounded-lg p-2 text-gray-400 transition-colors hover:bg-white/10 hover:text-white" aria-label="Ver notificaciones"><Bell size={20} /></button>
            <button type="button" onClick={cerrarSesion} className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-red-600 to-red-800 text-sm font-bold shadow-lg transition duration-300 hover:scale-105" title="Cerrar sesión">AD</button>
          </div>
        </header>
