...
class LoginViewModel : ViewModel() {
    ...
    fun crearCuenta(
        ...
        viewModelScope.launch {
            ...
            try {
                if (rolSeleccionado.contains("ENTRENADOR", ignoreCase = true)) {
                    errorMessage = "Las cuentas de entrenador las crea un administrador desde la web."
                    return@launch
                }
                ...
                val response = RetrofitClient.apiService.registrarSocio(request)
