        ...
        <form onSubmit={handleLogin} className="space-y-5">
          <div>
            ...
            <div className="relative mt-2">
              ...
              <input type="text" className="w-full bg-[#171717] border border-white/5 rounded-xl py-3 pl-10 text-white outline-none focus:border-red-600" placeholder="Ingresa tu correo" />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative mt-2">
              ...
              <input type="password" className="w-full bg-[#171717] border border-white/5 rounded-xl py-3 pl-10 text-white outline-none focus:border-red-600" placeholder="Ingresa tu contraseña" />
            </div>
          </div>
          ...
          <div>
            ...
            <select 
              className="w-full mt-2 bg-[#171717] border border-white/5 rounded-xl py-3 px-4 text-white outline-none focus:border-red-600"
          ...
          <button type="submit" className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-3.5 rounded-xl mt-4 transition-all shadow-lg shadow-red-900/20">
            Iniciar sesión                 
          </button>
        </form>
      </div>
