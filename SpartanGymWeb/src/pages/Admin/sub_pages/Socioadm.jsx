    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select 
                  name="membresia" required value={formData.membresia} onChange={handleChange}
            ...
            <div className="pt-4 flex justify-end">
              <button 
                ...
                className={`flex items-center gap-2 font-bold py-3 px-8 rounded-xl transition-all shadow-lg text-sm
                  ${isSaved ? 'bg-green-600 text-white shadow-green-900/20' : 'bg-[#e50914] hover:bg-red-700 text-white shadow-red-900/20'} 
                  ${isSubmitting ? 'opacity-70 cursor-wait' : ''}
                `}
              >
                {isSubmitting ? 'Guardando...' : isSaved ? <><CheckCircle2 size={18} /> ¡Socio Guardado!</> : <><Save size={18} /> Completar Registro</>}
              </button>
            </div>
          </form>
        </div>
        ...
        <div className="bg-[#111111] rounded-2xl border border-white/5 p-6 lg:p-8 flex flex-col items-center shadow-lg h-fit">
          ...
          <div className="w-full max-w-sm bg-gradient-to-br from-[#1a1a1a] to-[#050505] rounded-2xl border border-white/10 p-5 flex flex-col items-center shadow-2xl relative">
            ...
            <h4 className="text-lg font-bold text-white text-center w-full px-2">
              {formData.nombre || formData.apellido ? `${formData.nombre} ${formData.apellido}` : 'Nombre del Socio'}
            </h4>
...
export default RegistrarSocioadm;